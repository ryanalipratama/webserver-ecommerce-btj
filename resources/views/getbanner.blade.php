    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('banner.create') }}" class="btn btn-primary mb-3">Tambah Data Banner</a>
                        <div class="card">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah yakin ingin menghapus data banner ini?</p>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <form action="{{ route('banner.delete', ['id' => $b->id]) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
